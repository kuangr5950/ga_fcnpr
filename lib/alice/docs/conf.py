...
# -*- coding: utf-8 -*-
#
# alice documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'alice.tex', 'alice Documentation',
...
man_pages = [
    (master_doc, 'alice', 'alice Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'alice', 'alice Documentation',
     author, 'alice', 'One line description of project.',
     'Miscellaneous'),
]
